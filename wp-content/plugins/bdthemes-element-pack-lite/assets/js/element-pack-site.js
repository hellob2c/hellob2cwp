 ...
 $window.on('elementor/frontend/init', function ($) {
     ...
     Confetti = ModuleHandler.extend({
         ...
         run: function () {
             ...
             var testCanvas = this.$element,
                 dataId = jQuery(this.$element).data('id');
             ...
             var instanceConfetti = {
                 executeConfetti: function () {
                     ...
                     if ((this_instance.settings('type') == 'basic') ||
                         ...
                         var $instance = confetti(options);
                         // push instance on global object
                         this_instance.instance = $instance;
                     }
                 }
             }
             ...
             if (this.settings('confetti') == 'yes') {
                 ...
                 if ((this.settings('trigger_type') == 'click') || this.settings('trigger_type') == 'mouseover') {
                     jQuery(this.settings('trigger_selector')).on(this.settings('trigger_type'), function () {

...
class ElementPack_Live_Copy {
    ...
    public function live_copy_enqueue(){
        wp_enqueue_script( 'bdt-live-copy-storage', BDTEP_URL . 'includes/live-copy/assets/xdLocalStorage.min.js', [], BDTEP_VER );
        wp_enqueue_script( 'bdt-live-copy-scripts', BDTEP_URL . 'includes/live-copy/assets/element-pack-live-copy.min.js', [ 'jquery', 'bdt-live-copy-storage', 'elementor-editor'], BDTEP_VER, true);
